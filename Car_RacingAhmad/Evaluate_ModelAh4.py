...
def evaluate_model_sequence(model, data_input_test, data_target_test, data_actions_test, long_sequence):
    ...
    plot_samples_sequence(predictions, y_tar.numpy(), 'Multiple_Steps', 100)
...
def evaluation_mode():
    ...
    model_saved_path = './Model_Saved/Ah5model_intro_vae_completed_after_1000_epochs.pt'
    #model_saved_path = './Model_Saved/checkpoint.pt'
