...
from Load_Batch_Data_Pytorch4 import load_data_generator
...
def intro_vae_frame_prediction(device=torch.device("cuda:0"), batch_size=32,
    ...
    if load_check:
        ...
        checkpoint = torch.load("./Model_Saved/Ah4checkpoint.pt")
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        if epoch % save_period == 0:
            ...
            torch.save({'epoch': epoch,
                        ...
                        }, f'./{model_dir}/Ah4checkpoint.pt')

    # Save Model after training all the epochs
    torch.save(model.state_dict(), f'./{model_dir}/Ah4model_intro_vae_completed_after_{num_epochs}_epochs.pt')
