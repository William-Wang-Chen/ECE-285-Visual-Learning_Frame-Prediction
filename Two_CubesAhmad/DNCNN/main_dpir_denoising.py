...
def main():
    ...
    testset_name = 'images_folder'               # set test set,  'bsd68' | 'cbsd68' | 'set12'
    ...
    testsets = 'Preprocessed_Data_noise/test/Input_images'                # fixed
    results = 'Preprocessed_Data_denoiseDPIR25/test/Input_images'                  
